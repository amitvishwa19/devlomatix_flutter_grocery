...
class TrendingProducts extends StatelessWidget {
  final int length;
  const TrendingProducts({Key? key, required this.length}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  provider.setProductCategory('Trending Products');
          ...
          Consumer<ProductProvider>(builder: (context, list, child) {
            return Container(
                height: 200,
                ...
                child: ListView.builder(
                    ...
                    itemCount: list.hotProd.take(length).toList().length,
                    itemBuilder: (context, i) {
                      var item = list.trending[i];
